...
public class CreateProjectVisual extends JPanel implements DocumentListener {
    ...
    void read(WizardDescriptor d) {
        ...
        String val = (String)d.getProperty(GenAppWizardIterator.PROPERTY_PREFIX + "artifactid");
        txtProjectName.setText(val != null ? val : info.getDefaultValue("artifactid"));
        val = (String)d.getProperty("projectDir");
        txtProjectDir.setText(val != null ? val : "");
        val = (String)d.getProperty(GenAppWizardIterator.PROPERTY_PREFIX + "groupid");
        txtGroupId.setText(val != null ? val : info.getDefaultValue("groupid"));
        val = (String)d.getProperty(GenAppWizardIterator.PROPERTY_PREFIX + "version");
        txtVersion.setText(val != null ? val : info.getDefaultValue("version"));
        val = (String)d.getProperty(GenAppWizardIterator.PROPERTY_PREFIX + "package");
        txtPackageName.setText(val != null ? val : info.getDefaultValue("package"));
        val = (String)d.getProperty(GenAppWizardIterator.PROPERTY_PREFIX + "name");
        txtName.setText(val != null ? val : info.getDefaultValue("name"));
    }
    
    void store(WizardDescriptor d) {
        d.putProperty("artifactID", txtProjectName.getText());
        d.putProperty("projectDir", txtProjectDir.getText());
        d.putProperty(GenAppWizardIterator.PROPERTY_PREFIX + "artifactid", txtProjectName.getText());
        d.putProperty(GenAppWizardIterator.PROPERTY_PREFIX + "groupid", txtGroupId.getText());
        d.putProperty(GenAppWizardIterator.PROPERTY_PREFIX + "package", txtPackageName.getText());
        d.putProperty(GenAppWizardIterator.PROPERTY_PREFIX + "version", txtVersion.getText());
        d.putProperty(GenAppWizardIterator.PROPERTY_PREFIX + "name", txtName.getText());
    }
    ...
    private void initComponents() {
        ...
        lblProjectName.setText("Project (Artifact) ID:");
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 6, 6, 0);
        optionsContainer.add(lblName, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 6, 6, 6);
        optionsContainer.add(txtName, gridBagConstraints);
