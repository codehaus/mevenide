...
public class MavenJob extends Job {
    ...
    public MavenJob(Shell shell, ILaunchConfiguration configuration, IPath basedir, boolean showDialog) {
        super(Mevenide.getResourceString("MavenJob.Name")); //$NON-NLS-1$
    ...
    protected IStatus run(IProgressMonitor monitor) {
        ...
        return new Status(Status.OK, "org.mevenide.ui", 0, Mevenide.getResourceString("MavenJob.Done"), null); //$NON-NLS-1$ //$NON-NLS-2$
    }
