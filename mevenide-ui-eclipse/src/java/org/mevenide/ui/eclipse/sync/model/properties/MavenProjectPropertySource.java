...
public class MavenProjectPropertySource extends AbstractPomPropertySource {
	...
	private MavenProjectNode mavenProjectNode;
	...
	public MavenProjectPropertySource(MavenProjectNode mavenProjectNode) {
		this.mavenProjectNode = mavenProjectNode;
        descriptorPath = ((Project) mavenProjectNode.getData()).getFile().getAbsolutePath();
