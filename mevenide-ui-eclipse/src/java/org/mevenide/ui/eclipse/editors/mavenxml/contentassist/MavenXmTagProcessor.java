 ...
 * 
 */
public class MavenXmTagProcessor implements IContentAssistProcessor {
	
	private static final Log log = LogFactory.getLog(MavenXmTagProcessor.class);
	
	private IGoalsGrabber goalsGrabber;
	
	public MavenXmTagProcessor(TextEditor editor) throws Exception {
