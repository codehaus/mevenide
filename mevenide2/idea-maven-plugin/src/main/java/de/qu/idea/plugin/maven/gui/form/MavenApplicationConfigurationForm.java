/*
   @(#)MavenApplicationConfigurationForm.java   2006-10-24
...
import de.qu.idea.plugin.maven.common.MavenBuildPluginSettings;
 ...
 * @version $Revision$
 */
public class MavenApplicationConfigurationForm extends AbstractConfigurationForm {
   ...
   * Constructs ...
   */
  public MavenApplicationConfigurationForm() {
    setupForm();
  ...
  private void setupForm() {
    ...
    panel.add(labelMavenExecutable, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST,
        GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED,
        GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(357, 14), null));
    textFieldMavenHomeDir = new JTextField();
    panel.add(textFieldMavenHomeDir, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST,
        GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW,
        GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(357, 20), null));
    buttonMavenHomeDir = new JButton();
    buttonMavenHomeDir.setLabel("...");
    buttonMavenHomeDir.setText("...");
    panel.add(buttonMavenHomeDir, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_CENTER,
        GridConstraints.FILL_HORIZONTAL,
        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
    ...
    panel.add(textFieldAlternateSettingsFile, new GridConstraints(3, 0, 1, 1,
    ...
    panel.add(labelMavenGlobalCmdLineArgs, new GridConstraints(4, 0, 1, 1,
    ...
    panel.add(textFieldMavenCmdLineArgs, new GridConstraints(5, 0, 1, 2,
        GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL,
        GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null,
        new Dimension(150, -1), null));
    ...
    panel.add(labelVmOptions, new GridConstraints(6, 0, 1, 1,
        GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED,
        GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(357, 14), null));
    textFieldVmOptions = new JTextField();
    panel.add(textFieldVmOptions, new GridConstraints(7, 0, 1, 2,
        GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL,
        GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null,
        new Dimension(150, -1), null));
    rootComponent
    ...
    panelGeneral.add(spacer1, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
    ...
    panelGeneral.add(checkBoxScanForExistingPoms, new GridConstraints(0, 1, 1, 1,
