/*
   @(#)MavenBuildApplicationComponent.java   2006-10-24
...
import de.qu.idea.plugin.maven.action.PluginConfigurationActionListener;
import de.qu.idea.plugin.maven.build.util.BuildConstants;
import de.qu.idea.plugin.maven.common.MavenBuildPluginSettings;
import de.qu.idea.plugin.maven.gui.form.MavenApplicationConfigurationForm;
 ...
 * @version $Revision$
 */
public class MavenBuildApplicationComponent extends AbstractComponent
    implements ApplicationComponent, Configurable, JDOMExternalizable {
  private MavenApplicationConfigurationForm form;
   ...
   * Constructs ...
   */
  public MavenBuildApplicationComponent() {
  }
  ...
  public void apply() throws ConfigurationException {
    if (form != null) {
      MavenBuildPluginSettings pluginSettings =
          actionContext.getApplicationPluginSettings();
  ...
  public JComponent createComponent() {
    if (form == null) {
      form = new MavenApplicationConfigurationForm();
      ...
      actionContext.getGuiContext().setApplicationConfigurationForm(form);
    }
  ...
  public void readExternal(Element element) throws InvalidDataException {
    ...
    pluginSettings
        .setMavenSettingsFile(
            JDOMExternalizerUtil.readField(element, BuildConstants.MAVEN_OPTION_SETTINGS_FILE));
    ...
    pluginSettings.setMavenRepository(JDOMExternalizerUtil.readField(element,
        PluginConstants.CONFIG_ELEMENT_MAVEN_REPOSITORY));
    ...
    super.readExternal(actionContext.getApplicationPluginSettings(), element);
  }
  ...
  public void writeExternal(Element element) throws WriteExternalException {
    ...
    JDOMExternalizerUtil.writeField(element, PluginConstants.CONFIG_ELEMENT_MAVEN_REPOSITORY,
        pluginSettings.getMavenRepository());
  ...
  public String getComponentName() {
    return PluginConstants.APPLICATION_COMPONENT_NAME;
  }
  ...
  public String getDisplayName() {
    return PluginConstants.PLUGIN_GLOBAL_DISPLAY_NAME;
  }
