...
package de.qu.idea.plugin.maven.helper;
...
import de.qu.idea.plugin.maven.config.IdeaMavenPluginDocument;
import de.qu.idea.plugin.maven.config.PluginConfigDocument;
