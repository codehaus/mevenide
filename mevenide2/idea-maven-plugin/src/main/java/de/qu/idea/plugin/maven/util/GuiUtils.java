...
package de.qu.idea.plugin.maven.util;
...
public class GuiUtils {
   ...
   * @return Document me!
   */
  public static JMenuItem addMenuItem(JMenu menu, String menuItemText,
   ...
   * @return Document me!
   */
  public static JMenuItem addMenuItem(JPopupMenu popupMenu, String menuItemText,
                                      ActionListener actionListener) {
    JMenuItem menuItem = new JMenuItem(menuItemText);
   ...
   */
  public static JMenuItem addMenuItem(JMenu menu, String menuItemText,
                                      ActionListener actionListener, boolean isEnabled) {
    JMenuItem menuItem = new JMenuItem(menuItemText);
    ...
    if (!nodeList.isEmpty()) {
      for (DefaultMutableTreeNode aNodeList : nodeList) {
        ...
        if ((goalsParentNode.getUserObject() != null)
            && goalsParentNode.getUserObject().toString().equals(
   ...
   * @return Document me!
   */
  public static boolean allNodesAreOfTheSameType(List<DefaultMutableTreeNode> selectedNodeList,
                                                 Object clazz) {
