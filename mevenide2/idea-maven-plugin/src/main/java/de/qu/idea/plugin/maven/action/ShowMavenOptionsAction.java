...
public class ShowMavenOptionsAction extends AbstractBaseAction {
  ...
  public void actionPerformed(AnActionEvent actionEvent) {
    ...
    if (actionText.equals(PluginConstants.ACTION_COMMAND_SHOW_MAVEN_OPTIONS)) {
      getAndUpdateMavenOptionsPopupMenu(actionContext, mavenOptionsPopupMenu)
...
//      ActionUtils.chooseAndAddPluginToPom(context);
   ...
   */
  public JPopupMenu getAndUpdateMavenOptionsPopupMenu(ActionContext actionContext,
                                                      JPopupMenu mavenOptionsPopupMenu) {
