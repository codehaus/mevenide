...
package de.qu.idea.plugin.maven.component;
...
public class AbstractComponent {
   ...
   */
  public void readExternal(MavenBuildPluginSettings pluginSettings, Element element)
      throws InvalidDataException {
    pluginSettings.getMavenOptions()
        .setBatchMode(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_BATCH_MODE)));
    pluginSettings.getMavenOptions()
        .setCheckPluginUpdates(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_CHECK_PLUGIN_UPDATES)));
    pluginSettings.getMavenOptions()
        .setDebug(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_DEBUG)));
    pluginSettings.getMavenOptions()
        .setErrors(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_ERRORS)));
    pluginSettings.getMavenOptions()
        .setFailAtEnd(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_FAIL_AT_END)));
    pluginSettings.getMavenOptions()
        .setFailFast(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_FAIL_FAST)));
    pluginSettings.getMavenOptions()
        .setFailNever(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_FAIL_NEVER)));
    pluginSettings.getMavenOptions()
        .setLaxChecksums(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_LAX_CHECKSUM)));
    pluginSettings.getMavenOptions()
        .setNonRecursive(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_NON_RECURSIVE)));
    pluginSettings.getMavenOptions()
        .setNoPluginRegistry(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_NO_PLUGIN_REGISTRY)));
    pluginSettings.getMavenOptions()
        .setNoPluginUpdates(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_NO_PLUGIN_UPDATES)));
    pluginSettings.getMavenOptions()
        .setOffline(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_OFFLINE)));
    pluginSettings.getMavenOptions()
        .setReactor(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_REACTOR)));
    pluginSettings.getMavenOptions()
        .setStrictChecksums(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_STRICT_CHECKSUM)));
    pluginSettings.getMavenOptions()
        .setUpdatePlugins(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_UPDATE_PLUGINS)));
    pluginSettings.getMavenOptions()
        .setUpdateSnapshots(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
            BuildConstants.MAVEN_OPTION_UPDATE_SNAPSHOTS)));
    pluginSettings.getMavenOptions()
        .setSkipTests(Boolean.valueOf(JDOMExternalizerUtil.readField(element,
   ...
   *
   */
  public void writeExternal(MavenBuildPluginSettings pluginSettings, Element element)
