...
public class SortAction extends AbstractBaseAction {
  ...
  public void update(AnActionEvent e) {
    ...
    if (actionContext != null && actionContext.getGuiContext().getMavenToolWindowForm() != null) {
      DefaultMutableTreeNode selectedNode =
          GuiUtils.getSelectedNodeObject(((MavenBuildProjectToolWindowForm) actionContext
  ...
  private void sortNodesAscending(ActionContext context) {
    ...
    DefaultMutableTreeNode rootNode =
        sortTree(GuiUtils.getSelectedNodeObject(pomTree));
    ...
    if (startNode != null) {
      do {
        ...
        for (int i = 1; i < startNode.getChildCount(); i++) {
          ...
          if (nodeLeft.getUserObject().toString().compareToIgnoreCase(
              nodeRight.getUserObject().toString()) > 0) {
