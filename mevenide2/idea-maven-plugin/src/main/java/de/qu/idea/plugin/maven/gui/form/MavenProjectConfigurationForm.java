/*
   @(#)MavenProjectConfigurationForm.java   2006-10-24
...
package de.qu.idea.plugin.maven.gui.form;

import com.intellij.uiDesigner.core.GridConstraints;
import com.intellij.uiDesigner.core.GridLayoutManager;
import de.qu.idea.plugin.maven.common.MavenBuildProjectPluginSettings;
...
public class MavenProjectConfigurationForm extends AbstractConfigurationForm {
   ...
   */
  public MavenProjectConfigurationForm(ActionContext context) {
    setupForm();
    this.context = context;

    buttonMavenHomeDir.setActionCommand(PluginConstants.ACTION_COMMAND_SET_MAVEN_HOME);
    buttonAlternativeSettingsFile
        .setActionCommand(PluginConstants.ACTION_COMMAND_SET_ALTERNATE_SETTINGS);
  }
   ...
   */
  public void getData(MavenBuildProjectPluginSettings data) {
    getApplicationWideData(data);
    ...
    ((MavenBuildProjectToolWindowForm) context.getGuiContext().getMavenToolWindowForm())
        .getTextFieldCmdLine()
        .setText(data.getMavenCommandLineParams());
  }
   ...
   * @param data Document me!
   */
  public void setData(MavenBuildProjectPluginSettings data) {
    setApplicationWideData(data);
    textFieldMavenCmdLineArgs
        .setText(
            ((MavenBuildProjectToolWindowForm) context.getGuiContext().getMavenToolWindowForm())
                .getTextFieldCmdLine().getText());
   ...
   * @return Document me!
   */
  public boolean isModified(MavenBuildProjectPluginSettings data) {
    return isApplicationWideDataModified(data) ||
        (checkBoxUseMavenEmbedder.isSelected() != data.isUseMavenEmbedder());
  }
  ...
  private void setupForm() {
    ...
    panel1.add(panel, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_NORTH,
    ...
    panel.add(labelAlternativeSettingsFile, new GridConstraints(3, 0, 1, 1,
        GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED,
        GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(357, 14), null));
    JLabel labelMavenGlobalCmdLineArgs = new JLabel();
    labelMavenGlobalCmdLineArgs
        .setText(PluginConstants.CONFIG_DIALOG_LABEL_MAVEN_GLOBAL_COMMAND_LINE_ARGUMENTS);
    panel.add(labelMavenGlobalCmdLineArgs, new GridConstraints(5, 0, 1, 1,
        GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED,
        GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(357, 14), null));
    textFieldMavenHomeDir = new JTextField();
    panel.add(textFieldMavenHomeDir, new GridConstraints(2, 0, 1, 1,
    ...
    panel.add(buttonMavenHomeDir, new GridConstraints(2, 1, 1, 1,
        GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL,
        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
        GridConstraints.SIZEPOLICY_FIXED, null, null, null));
    textFieldAlternateSettingsFile = new JTextField();
    panel.add(textFieldAlternateSettingsFile, new GridConstraints(4, 0, 1, 1,
        GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL,
        GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null,
    ...
    panel.add(textFieldMavenCmdLineArgs, new GridConstraints(6, 0, 1, 2,
        GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL,
        GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null,
        new Dimension(150, -1), null));
    labelVmOptions = new JLabel();
    labelVmOptions
        .setText(PluginConstants.CONFIG_DIALOG_LABEL_VM_OPTIONS);
    panel.add(labelVmOptions, new GridConstraints(7, 0, 1, 1,
        GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED,
        GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(357, 14), null));
    textFieldVmOptions = new JTextField();
    panel.add(textFieldVmOptions, new GridConstraints(8, 0, 1, 2,
        GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL,
        GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null,
        new Dimension(150, -1), null));
    rootComponent
        .addTab(PluginConstants.CONFIG_DIALOG_TAB_MAVEN_OPTIONS, createMavenOptionsPanel());
  }
