...
public class LogHelper {
  ...
  public static void notifyListeners(List<LogListener> listeners, String prependString,
                                     String message, Throwable throwable, int outputType) {
  ...
  public static void notifyListeners(List<LogListener> listeners, String message,
  ...
  public static void notifyListeners(List<LogListener> listeners, String message,
                                     Throwable throwable, int outputType, boolean isRaiseFatalError) {
    StringBuffer buffer = new StringBuffer();
    buffer.append(message).append(System.getProperty("line.separator"));
    notify(listeners, throwable, buffer, outputType, isRaiseFatalError);
  }

  private static void notify(List<LogListener> listeners, Throwable throwable, StringBuffer buffer,
                             int outputType, boolean isRaisFatalError) {
    String stackTrace = null;
    if (throwable != null) {
      Throwable cause = ExceptionUtils.getCause(throwable);
      stackTrace = ExceptionUtils
          .getStackTrace(cause != null ? ExceptionUtils.getCause(throwable) : throwable);
