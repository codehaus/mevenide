...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.setLayout(new FormLayout("fill:d:noGrow,left:4dlu:noGrow,fill:max(d;4px):noGrow",
                "center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,top:max(d;4px):noGrow"));
        ...
        panel1.add(textFieldMavenHomeDirectory, cc.xy(1, 7, CellConstraints.FILL, CellConstraints.DEFAULT));
        ...
        panel1.add(labelBrowseMavenHomeDirectory, cc.xy(1, 5));
        ...
        checkBoxRunMavenInBackground = new JCheckBox();
        checkBoxRunMavenInBackground.setSelected(false);
        checkBoxRunMavenInBackground.setText("Run Maven in background");
        checkBoxRunMavenInBackground.setMnemonic('B');
        checkBoxRunMavenInBackground.setDisplayedMnemonicIndex(13);
        panel1.add(checkBoxRunMavenInBackground, cc.xy(1, 3));
