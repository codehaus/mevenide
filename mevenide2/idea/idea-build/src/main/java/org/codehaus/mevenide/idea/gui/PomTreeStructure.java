...
public class PomTreeStructure extends SimpleTreeStructure {
    ...
    @NonNls
    private static final String POM_TAG = "pom";
    @NonNls
    private static final String POM_OPTIONS_TAG = "pom-options";
    @NonNls
    private static final String ID_ATTR = "id";

    @NonNls
    private static final String POM_TREE_TAG = "pom-tree";
    @NonNls
    private static final String GROUP_BY_MODULE_ATTR = "groupByModule";
    @NonNls
    private static final String GROUP_BY_DIRECTORY_ATTR = "groupByDirectory";
    @NonNls
    private static final String FILTER_STANDARD_PHASES_ATTR = "filterStandardPhases";

    Map<String, Integer> standardGoalOrder;

    public PomTreeStructure(Project project, IMavenBuildConfiguration pluginSettings) {
    ...
    public void readExternal(Element root) {
        ...
        if (element != null) {
            ...
            settings.groupByDirectory =
                    Boolean.valueOf(JDOMExternalizerUtil.readField(element, GROUP_BY_DIRECTORY_ATTR));
            settings.filterStandardPhases =
                    Boolean.valueOf(JDOMExternalizerUtil.readField(element, FILTER_STANDARD_PHASES_ATTR));
        }
    ...
    public void writeExternal(Element root) {
        ...
        JDOMExternalizerUtil
                .writeField(element, FILTER_STANDARD_PHASES_ATTR, Boolean.toString(settings.filterStandardPhases));
    ...
    public <T extends SimpleNode> Collection<T> filterNodes(Collection<SimpleNode> nodes, Class<T> aClass,
                                                            boolean strict) {
