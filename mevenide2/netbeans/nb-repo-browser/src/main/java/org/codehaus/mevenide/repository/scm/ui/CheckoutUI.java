 ...
 */
package org.codehaus.mevenide.repository.scm.ui;
...
public class CheckoutUI extends javax.swing.JPanel {
    ...
    public CheckoutUI(StandardArtifactIndexRecord record, Scm scm) {
        this.scm = scm;
        this.record = record;
    ...
    public RunConfig getRunConfig() {
        ...
        return new RunConfig() {
            ...
            public String getTaskDisplayName() {
                return NbBundle.getMessage(CheckoutUI.class, "LBL_Checkout", record.getArtifactId() + " : " + record.getVersion().toString());
            }
