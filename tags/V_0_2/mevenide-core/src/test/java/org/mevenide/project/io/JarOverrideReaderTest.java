...
public class JarOverrideReaderTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		projectProperties = projectModelFactory.newPropertyModel(new File(pom.getParent(), "project.properties"));
		buildProperties = projectModelFactory.newPropertyModel(new File(pom.getParent(), "build.properties"));
