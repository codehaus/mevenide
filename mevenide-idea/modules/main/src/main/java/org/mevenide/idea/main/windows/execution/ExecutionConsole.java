...
public class ExecutionConsole extends JPanel {
    ...
    private static final String COMPILE_REGEXP = RegexpFilter.FILE_PATH_MACROS + ":" + RegexpFilter.LINE_MACROS;
        ...
        public void actionPerformed(AnActionEvent pEvent) {
            try {
                ...
                if (parent.getComponentCount() == 0) {
                    final ToolWindow toolWindow = ExecutionToolWindow.getToolWindow(project);
