...
package org.netbeans.maven.customizer;
 ...
 * @author mkleint
 */
public class LibrariesPanelProvider implements ProjectCustomizer.CompositeCategoryProvider {
    
    /** Creates a new instance of ActionMappingsPanel */
    public LibrariesPanelProvider() {
    }
    
    public Category createCategory(Lookup context) {
        return ProjectCustomizer.Category.create(
                ModelHandle.PANEL_LIBRARIES, 
                NbBundle.getMessage(ActionMappingsPanelProvider.class, "TIT_Libraries"), 
                null,
