...
import org.netbeans.maven.queries.MavenFileOwnerQueryImpl;
...
class ProjectOpenedHookImpl extends ProjectOpenedHook {
    ...
    protected void projectOpened() {
        ...
        ClassPathProviderImpl cpProvider = project.getLookup().lookup(org.netbeans.maven.classpath.ClassPathProviderImpl.class);
