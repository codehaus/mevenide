...
/**
 * TODO: create a GoalsGrabberJDOMExternalizer This is a generic goals grabber with equals
 * and hashcode, and copy-ctor
 *
 * @author Arik
 */
public class CustomGoalsGrabber extends AbstractGoalsGrabber
        ...
        for (final String plugin : plugins) {
            ...
            for (final String goal : goals) {
                ...
                final String prereqs = StringUtils.join(pGoalsGrabber.getPrereqs(fqName),
                                                        ',');
                registerGoal(fqName,
                             StringUtils.defaultString(desc) + ">" + StringUtils.defaultString(
                                 prereqs));
            }
        }
    }
    ...
    @Override
    public void registerGoal(String fullyQualifiedGoalName, String properties) {
        super.registerGoal(fullyQualifiedGoalName, properties);
    }

    @Override
    public void registerGoalName(String fullyQualifiedGoalName) {
        super.registerGoalName(fullyQualifiedGoalName);
    }

    @Override
    public void registerGoalProperties(String fullyQualifiedGoalName, String properties) {
