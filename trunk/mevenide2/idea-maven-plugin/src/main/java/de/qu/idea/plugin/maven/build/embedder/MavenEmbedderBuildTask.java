...
package de.qu.idea.plugin.maven.build.embedder;

import com.intellij.openapi.progress.ProgressManager;
import de.qu.idea.plugin.maven.build.AbstractMavenBuildTask;
import de.qu.idea.plugin.maven.build.IBuildEnvironment;
import de.qu.idea.plugin.maven.build.LogListener;
    ...
    try {
      ...
      String mavenSettingsFile =
          StringUtils.defaultString(
              buildEnvironment.getMavenBuildSettings().getMavenSettingsFile());
      req.setSettings(maven.buildSettings(
          new File(mavenSettingsFile),
      ...
      req.addEventMonitor(
          new MavenEmbedderBuildEventMonitor(ProgressManager.getInstance().getProgressIndicator(),
              this));
      ...
      if (isCancelled()) {
        logger.info(System.getProperty("line.separator") + BuildConstants
            .MESSAGE_EMBEDDED_MAVENBUILD_ABORTED,
