...
import de.qu.idea.plugin.maven.build.MavenBuildCancelledException;
...
public class MavenEmbedderBuildEventMonitor implements EventMonitor {
  ...
  public MavenEmbedderBuildEventMonitor(ProgressIndicator progressIndicator,
                                        AbstractMavenBuildTask buildTask) {
  ...
  public void startEvent(String eventName, String target, long timestamp) {
    if (progressIndicator.isCanceled()) {
      buildTask.cancel();
      throw new MavenBuildCancelledException(System.getProperty("line.separator") + BuildConstants
