/*
   @(#)RunGoalsAction.java   2006-10-24
...
public class RunGoalsAction extends AbstractBaseAction {
  ...
  public void actionPerformed(AnActionEvent actionEvent) {
    ...
    if (actionText.equals(PluginConstants.ACTION_COMMAND_RUN_GOALS)) {
      try {
        ActionUtils.runSelectedGoals(actionContext,
            GuiUtils.getSortedSelectedNodeObjects(((MavenBuildProjectToolWindowForm) actionContext
  ...
  public void update(AnActionEvent e) {
    ...
    if (actionContext != null  && actionContext.getGuiContext().getMavenToolWindowForm() != null) {
      List<DefaultMutableTreeNode> selectedNodeList =
          GuiUtils.getSelectedNodeObjects(((MavenBuildProjectToolWindowForm) actionContext
              .getGuiContext().getMavenToolWindowForm()).getPomTree());
