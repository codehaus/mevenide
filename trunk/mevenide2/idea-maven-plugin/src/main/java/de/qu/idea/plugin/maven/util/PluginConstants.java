/*
   @(#)PluginConstants.java   2006-10-24
...
public class PluginConstants {
  ...
  public static final String CONFIG_DIALOG_CHECKBOX_LABEL_SCAN_POMS =
      "Scan for existing POMs on project startup";
  public static final String CONFIG_DIALOG_CHECKBOX_LABEL_USE_MAVEN_EMBEDDER =
      "Use Maven Embedder (Experimental)";
