...
public class ErrorHandler {
  ...
  public static void processAndShowError(Project project, Throwable error) {
    ...
    Messages.showErrorDialog(
        ...
        (ExceptionUtils.getRootCause(error) != null)
            ...
            : ExceptionUtils.getFullStackTrace(error), "Maven 2 Integration plugin error");
  }
  ...
  public static void processAndShowError(Project project, Throwable error,
    ...
    LOG.error(error.getMessage(), error);
    Messages.showErrorDialog(
        project, showStacktrace ?
        (ExceptionUtils.getRootCause(error) != null)
            ? ExceptionUtils.getFullStackTrace(ExceptionUtils.getRootCause(error))
            : ExceptionUtils.getFullStackTrace(error) : error.getMessage(),
        "Maven-2 Integration plugin error");
  }
