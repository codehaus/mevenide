...
import de.qu.idea.plugin.maven.build.AbstractMavenBuildManager;
import de.qu.idea.plugin.maven.build.BuildException;
import de.qu.idea.plugin.maven.build.IBuildEnvironment;
import de.qu.idea.plugin.maven.build.IMavenBuildLogger;
import de.qu.idea.plugin.maven.build.MavenBuildFormattedLogger;
import de.qu.idea.plugin.maven.build.MavenBuildManager;
import de.qu.idea.plugin.maven.build.embedder.MavenEmbedderBuildLogger;
import de.qu.idea.plugin.maven.build.embedder.MavenEmbedderBuildManager;
import de.qu.idea.plugin.maven.common.util.BuildUtils;
import de.qu.idea.plugin.maven.helper.ActionContext;
import de.qu.idea.plugin.maven.helper.BuildContext;
import de.qu.idea.plugin.maven.helper.IdeaBuildEnvironment;
...
public class MavenRunner {
  ...
  private static final String COMPILE_REGEXP_JAR = RegexpFilter.FILE_PATH_MACROS + ":"
      + RegexpFilter.LINE_MACROS;
  ...
  public MavenRunner(BuildContext buildContext) {
    ...
    ToolWindowManager manager =
        ToolWindowManager.getInstance(context.getPluginProject());
  ...
  private void startEmbeddedMavenExecution() throws BuildException {
    ...
    buildEnvironment
        .setLogger((MavenEmbedderBuildLogger) buildContext.getMavenEmbedder().getLogger());
  ...
  private ConsoleView createConsoleView(Project project) {
    ...
    Filter[] filters = new Filter[]{new ExceptionFilter(project),
