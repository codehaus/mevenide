/*
   @(#)AbstractConfigurationForm.java   2006-10-24
...
import de.qu.idea.plugin.maven.build.IMavenBuildSettings;
...
public abstract class AbstractConfigurationForm extends AbstractForm {
  ...
  protected JPanel createMavenOptionsPanel() {
    ...
    mavenOptionsPanel.add(checkBoxStrictChecksums, new GridConstraints(1, 0, 1, 1,
    ...
    mavenOptionsPanel.add(checkBoxLaxChecksums, new GridConstraints(2, 0, 1, 1,
        GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
        GridConstraints.SIZEPOLICY_FIXED, null, null, null));
    checkBoxFailFast = new JCheckBox();
    checkBoxFailFast.setText(BuildConstants.MAVEN_OPTION_FAIL_FAST);
    mavenOptionsPanel.add(checkBoxFailFast, new GridConstraints(3, 0, 1, 1,
        GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
        GridConstraints.SIZEPOLICY_FIXED, null, null, null));
    checkBoxBatchMode = new JCheckBox();
    checkBoxBatchMode.setText(BuildConstants.MAVEN_OPTION_BATCH_MODE);
    mavenOptionsPanel.add(checkBoxBatchMode, new GridConstraints(4, 0, 1, 1,
        GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
        GridConstraints.SIZEPOLICY_FIXED, null, null, null));
