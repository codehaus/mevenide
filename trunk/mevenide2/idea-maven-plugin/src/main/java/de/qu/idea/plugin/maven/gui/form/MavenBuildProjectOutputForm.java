...
public class MavenBuildProjectOutputForm extends AbstractForm implements LogListener {
  ...
  private static Hashtable<Integer, ConsoleViewContentType> outputTypeMap =
      new Hashtable<Integer, ConsoleViewContentType>();
  ...
  public MavenBuildProjectOutputForm(ConsoleView view) {
    ...
    panel.add(view.getComponent(), new GridConstraints(0, 1, 1, 1,
  ...
  public void printMessage(String message, String stackTrace, int outputType) {
    ...
    if (consoleView != null) {
      consoleView.print(message,
          outputTypeMap.get(outputType));
      if (stackTrace != null) {
        consoleView.print(stackTrace,
