	        ...
	        public void widgetSelected(SelectionEvent arg0) {
                ...
                if ( !StringUtils.isNull(choice) ) {
                    ...
                    try {
                        ...
                        properties.store(output, "Generated by Mevenide " + new SimpleDateFormat("yyyyMMdd").format(new Date()));
                    }
                    catch (Exception e) {
                        String message = "Unable to store properties"; 
                        log.error(message, e);
                    }
                    finally {
                        if ( output != null ) {
                            try {
                                ...
                                String message = "Unable to close outputStream"; 
                                log.warn(message, e1);
                            }
                        }
                    }
